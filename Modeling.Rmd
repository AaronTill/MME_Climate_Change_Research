...
lasso_summer_predictions$quantile <- quantile(lasso_summer_predictions$Prob,probs = c(min(lasso_summer_predictions$Prob), max(lasso_summer_predictions$Prob)), na.rm = TRUE)
