...
# Normal Logistic Regression for Summerkill 

With variables from lasso 1se feature selection: Mean surf, cummulative above zero, V2


```{r creating reg_predictions and quartiles}
set.seed(1234)

regression_model <- glm(Summerkill ~ Mean_Surf_Temp + Cumulative_Above_0 + V2, family = 'binomial', data= main_data) # data sample for predictions
