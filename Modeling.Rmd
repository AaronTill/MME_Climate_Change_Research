...
reg_predictions$super_risk <-ifelse(reg_predictions$Prob > 0.9, 1, 0) # REPLACE with Top Quartile
reg_predictions$low_chance <- ifelse(reg_predictions$Prob > 0.05, 1, 0) # REPLACE with Bot Quartile
```
