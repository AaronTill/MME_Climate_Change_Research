...
Taken from feature selection of lasso regression


```{r}

logreg_summerkill <- glm(Summerkill ~ Mean_Surf_Temp + Cumulative_Above_0 + V2, family = 'binomial', data= main_data)
summary(logreg_summerkill)



log_plot_summerkill <- av.plot(logreg_summerkill, 
