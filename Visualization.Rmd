...
map_data_w <- merge(as.data.frame(spatial_w), as.data.frame(coordinates(spatial_w)))
...
MME_lakes_of_wisconsin <- ggmap(Wisconsin_map) +
  ...
  geom_path(data = map_data_w, aes(x = V1, y = V2))# +
  #coord_equal()
...
https://rstudio.reed.edu/s/208caf3c63252c331037f/graphics/plot_zoom_png?width=771&height=291
