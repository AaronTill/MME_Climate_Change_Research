...
ttest_winter <- filter(combined_data_restricted_ultimate, Cause.Category.4 == 'ANTHROPOGENIC CONDITION' )
...
Wisconsin_map <- get_map(bbox, zoom = 7, maptype = 'toner-background', source = 'stamen')
ggmap(Wisconsin_map)
