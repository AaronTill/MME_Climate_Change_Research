...
combined_data_restricted$sig <- ifelse(combined_data_restricted$Cause.Category.4 == 'SUMMERKILL', 'p < 0.05', 'p > 0.05')
combined_data_restricted$sig <- factor(combined_data_restricted$sig, levels = c('p > 0.05', 'p < 0.05'))
...
ttest_data_infectious<- filter(mean_surf(anova_data), Cause.Category.4 == 'SUMMER NON-EVENT')
...
xbox <- grid.arrange(boxplot1_winter, boxplot1,  ncol = 2, widths = c(0.57, 1.0))
ybox <- grid.arrange(boxplot2_winter,boxplot2, ncol = 2, widths = c(0.57, 1.0))
