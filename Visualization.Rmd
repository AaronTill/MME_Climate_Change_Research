...
ggplot(aes(x=factor(Year), y = Summerkill, fill = Temp)) + 
  ...
  theme(axis.text.x=element_text(angle=90,hjust=1), legend.position = 'left',
    text = element_text(size=10), plot.title = element_text(margin = margin(b = -50))) +
  ggtitle('A')
plot1
...
color_seperated_lakes_of_wisconsin <- ggmap(Wisconsin_map) +
  ...
  theme(text = element_text(size=10), plot.title = element_text(margin = margin(b = -25), hjust = 0.02)) +
  ggtitle('A')
