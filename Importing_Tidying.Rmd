...
#spatial_w <-
 # filter(spatial_w@data$NAME == 'Wisconsin')
...
fuzz <- function(x, y) {
  ifelse(abs(x-y)>= 0.1, FALSE, TRUE)
}


main_data_census <- fuzzy_left_join(main_data,census_w_frame, by = c('V1', 'V1'), match_fun = fuzz)
#list(x = c('V1', 'V1'), y = c('V2', 'V2'))
