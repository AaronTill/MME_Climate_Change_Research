...
main_data_no_spatial <- combined_data_restricted %>%
...
main_data_no_spatial <- main_data_no_spatial %>%
...
main_data_no_spatial$qudratic_temp <- main_data_no_spatial$Mean_Surf_Temp^2 
