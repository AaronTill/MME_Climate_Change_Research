...
bbox <- extent(-92.9, 42.4, -87, 46.9)

a <- raster('2004/PRISM_ppt_stable_4kmM3_200412_asc.asc') %>%
  crop(bbox)
...
snow_2004_12 <- cbind(a1, a2) 
  
snow_2004_12$V1 <- round(snow_2004_12$x, 1)
snow_2004_12$V2 <- round(snow_2004_12$y, 1)  
  
snow_2004_12 <- snow_2004_12 %>%
  group_by(V1, V2) %>%
  summarise(snow = mean(PRISM_ppt_stable_4kmM3_200412_asc))
```

snow_2004_01 <- raster('2004/PRISM_ppt_stable_4kmM3_200401_asc.asc') %>%
  crop(bbox)
snow_2004_02 <- raster('2004/PRISM_ppt_stable_4kmM3_200402_asc.asc') %>%
  crop(bbox)
snow_2005_12 <- raster('2005/PRISM_ppt_stable_4kmM3_200512_asc.asc') %>%
  crop(bbox)
snow_2005_01 <- raster('2005/PRISM_ppt_stable_4kmM3_200501_asc.asc') %>%
  crop(bbox)
snow_2005_02 <- raster('2005/PRISM_ppt_stable_4kmM3_200502_asc.asc') %>%
  crop(bbox)
snow_2006_12 <- raster('2006/PRISM_ppt_stable_4kmM3_200612_asc.asc') %>%
  crop(bbox)
snow_2006_01 <- raster('2006/PRISM_ppt_stable_4kmM3_200601_asc.asc') %>%
  crop(bbox)
snow_2006_02 <- raster('2006/PRISM_ppt_stable_4kmM3_200602_asc.asc') %>%
  crop(bbox)
snow_2007_01 <- raster('2007/PRISM_ppt_stable_4kmM3_200701_asc.asc') %>%
  crop(bbox)
snow_2007_02 <- raster('2007/PRISM_ppt_stable_4kmM3_200702_asc.asc') %>%
  crop(bbox)
snow_2007_12 <- raster('2007/PRISM_ppt_stable_4kmM3_200712_asc.asc') %>%
  crop(bbox)
snow_2008_01 <- raster('2008/PRISM_ppt_stable_4kmM3_200801_asc.asc') %>%
  crop(bbox)
snow_2008_02 <- raster('2008/PRISM_ppt_stable_4kmM3_200802_asc.asc') %>%
  crop(bbox)
snow_2008_12 <- raster('2008/PRISM_ppt_stable_4kmM3_200812_asc.asc') %>%
  crop(bbox)
snow_2009_01 <- raster('2009/PRISM_ppt_stable_4kmM3_200901_asc.asc') %>%
  crop(bbox)
snow_2009_02 <- raster('2009/PRISM_ppt_stable_4kmM3_200902_asc.asc') %>%
  crop(bbox)
snow_2009_12 <- raster('2009/PRISM_ppt_stable_4kmM3_200912_asc.asc') %>%
  crop(bbox)
snow_2010_01 <- raster('2010/PRISM_ppt_stable_4kmM3_201001_asc.asc') %>%
  crop(bbox)
snow_2010_02 <- raster('2010/PRISM_ppt_stable_4kmM3_201002_asc.asc') %>%
  crop(bbox)
snow_2010_12 <- raster('2010/PRISM_ppt_stable_4kmM3_201012_asc.asc') %>%
  crop(bbox)
snow_2011_01 <- raster('2011/PRISM_ppt_stable_4kmM3_201101_asc.asc') %>%
  crop(bbox)
snow_2011_02 <- raster('2011/PRISM_ppt_stable_4kmM3_201102_asc.asc') %>%
  crop(bbox)
snow_2011_12 <- raster('2011/PRISM_ppt_stable_4kmM3_201212_asc.asc') %>%
  crop(bbox)
snow_2012_01 <- raster('2012/PRISM_ppt_stable_4kmM3_201201_asc.asc') %>%
  crop(bbox)
snow_2012_02 <- raster('2012/PRISM_ppt_stable_4kmM3_201202_asc.asc') %>%
  crop(bbox)
snow_2012_12 <- raster('2012/PRISM_ppt_stable_4kmM3_201212_asc.asc') %>%
  crop(bbox)
snow_2013_01 <- raster('2013/PRISM_ppt_stable_4kmM3_201301_asc.asc') %>%
  crop(bbox)
snow_2013_02 <- raster('2013/PRISM_ppt_stable_4kmM3_201302_asc.asc') %>%
  crop(bbox)
snow_2013_12 <- raster('2013/PRISM_ppt_stable_4kmM3_201312_asc.asc') %>%
  crop(bbox)
